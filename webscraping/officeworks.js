...
export async function scrapeOfficeworks() {
    ...
    const postcode = "3150";
    const storelocator_url = "https://www.officeworks.com.au/shop/officeworks/storelocator/" + postcode;

    const query = "apple";
    const search_url = "https://www.officeworks.com.au/shop/officeworks/search?q=" + query;
